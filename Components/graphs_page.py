...
from GUI.graphs_window_ui import Ui_MainWindow
from db.Database import Database
from charts.ChartController import ChartController
...
class GraphsPage(QMainWindow):
    ...
    def build_graph(self):
        ...
        self.ChartController = ChartController(self.ui.graf_type.currentIndex(), str,
                                               users, self.ui.month_start.currentIndex() + 1,
                                               self.ui.month_end.currentIndex() + 1, self.ui.year_start.currentText(),
                                               self.ui.year_end.currentText(),sub_types)
        self.ChartController.control_graph()
